...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { term: "Operative Directory", desc: "The people directory. Search for anyone, filter by team, and click a name to see their details, skills and how busy they are." },
